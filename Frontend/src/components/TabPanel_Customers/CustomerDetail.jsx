        ...
        >
            <div className='mt-2'>
                <div className='flex justify-between items-center m-2'>
                    ...
                    <InputText id="txt_tipo_documento" value={typeDocument} className='w-4' />
                </div>
                <div className='flex justify-between items-center m-2'>
                    <label htmlFor="lbl_cedula" className="font-bold">Documento de Identificación:</label>
                    <InputText id="txt_cedula" value={customerDetail.Cedula} className='w-4' />
                </div>
                <div className='flex justify-between items-center m-2'>
                    <label htmlFor="lbl_nombre" className="font-bold">Nombre:</label>
                    <InputText id="txt_nombre" value={customerDetail.Nombre} className='w-4' />
                </div>
                <div className='flex justify-between items-center m-2'>
                    <label htmlFor="lbl_tel1" className="font-bold">Teléfono 1:</label>
                    <InputText id="txt_tel1" value={customerDetail.Telefono1} className='w-4' />
                </div>
                <div className='flex justify-between items-center m-2'>
                    <label htmlFor="lbl_tel2" className="font-bold">Teléfono 2:</label>
                    <InputText id="txt_tel2" value={customerDetail.Telefono2} className='w-4' />
                </div>
                <div className='flex justify-between items-center m-2'>
                    <label htmlFor="lbl_celular" className="font-bold">Celular:</label>
                    <InputText id="txt_celular" value={customerDetail.Celular} className='w-4' />
                </div>
                <div className='flex justify-between items-center m-2'>
                    <label htmlFor="lbl_direccion" className="font-bold">Dirección:</label>
                    <InputText id="txt_direccion" value={customerDetail.Direccion} className='w-4' />
                </div>
                <div className='flex justify-between items-center m-2'>
                    <label htmlFor="lbl_limite" className="font-bold">Limite:</label>
                    <InputText id="txt_limite" value={customerDetail.LimiteCredito} className='w-4' />
                </div>
                <div className='flex justify-between items-center m-2'>
                    <label htmlFor="lbl_plazo_credito" className="font-bold">Plazo de Crédito:</label>
                    <InputText id="txt_plazo_credito" value={customerDetail.PlazoCredito} className='w-4' />
                </div>
                <div className='flex justify-between items-center m-2'>
                    <label htmlFor="lbl_observacion" className="font-bold">Observaciones:</label>
                    <InputText id="txt_observacion" value={customerDetail.Observaciones} className='w-4' />
                </div>
            </div>
        </Dialog>
    )
