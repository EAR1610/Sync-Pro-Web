    ...
    useEffect(() => {
       const obtenerUsuarioCajas = async () => {
        try {
            ...
            mostarAlertaFlotante('info', 'Consultando el corte');
                ...
                <TabView>
                    <TabPanel header="Corte">
                        <div className="card flex justify-content-center">
                            ...
                            <div className=" ml-3 card flex justify-content-center bg-sky-600 text-white p-1 rounded-lg">
                                <Button label="CONSULTAR CORTE" onClick={ handleCorte }/>
                            </div>                            
                        </div>
                        <h2 className='text-center bg-green-300 font-bold p-1 mt-2 rounded-lg'>VENTAS TOTALES</h2>
                        ...
                        <h2 className='text-center bg-green-300 font-bold p-1 mt-2 rounded-lg'>GANANCIAS</h2>
                        <div className='flex flex-wrap justify-around'>
                            <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 mb-4 mt-1">                                
                        ...
                        <h2 className='text-center bg-sky-400 font-bold p-1 mt-2 rounded-lg'>DINERO EN CAJA</h2>
                        <div className='flex flex-wrap justify-around'>
                            <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 mb-4 mt-1">
                        ...
                        <h2 className='text-center bg-green-300 font-bold p-1 mt-2 rounded-lg'>EFECTIVO CAJA:</h2>
                        <div className='flex flex-wrap justify-around'>
                            <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 mb-4 mt-1">
                        ...
                        <h2 className='text-center bg-sky-400 font-bold p-1 mt-2 rounded-lg'>VENTAS:</h2>
                        <div className='flex flex-wrap justify-around'>
                            <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 mb-4 mt-1">
